...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        while (true)
        {
            ...
            std::string robotCompletionMessage;
            while (robotCompletionMessage != "OK")
            {
                robotCompletionMessage = robotSerialService.receive(1024);
            }

            std::cout << "From robot (Completed): " << robotCompletionMessage << std::endl;
